<div class="modal-dialog modal-dialog-centered modal-lg change_booking_hotel">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">{{__("Meals")}} - {{$attr_title}}</h5>
              ...
              @if(count($termss) > 0)
                ...
                ?>
                    <li class="appendRight20 relative">
                        <div class="altAcc"><span class="altAccoContainer">Meal</span></div>
                        ...
                        <div class="makeFlex">
                            ...
                            <a href="javascript:void(0);" class="font12 changeMeal" data-price="{{$price}}" data-timezone="{{$term->time_zone}}" data-index="{{$index}}">Add Now</a>
                        </div>
                    </li>
                @endforeach
                </ul>
