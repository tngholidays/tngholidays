            ...
            <div class="terms-scrollable">
                @foreach($attribute->terms as $term)
                    <label class="term-item">
                        <input @if(!empty($selected_terms) and $selected_terms->contains($term->id)) checked @endif price="{{$term->price}}" transfer="{{$term->transfer_price}}" type="checkbox" name="terms[]" @if($flag) class="SightSeeing" @endif value="{{$term->id}}">
