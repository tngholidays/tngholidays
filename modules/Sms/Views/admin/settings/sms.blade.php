...
@if(is_default_lang())
    <div class="row " data-condition="sms_driver:is(tradelit)">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__('Config Tradelit Driver')}}</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(tradelit)">
                        <div class="form-group">
                            <label class="">{{__("Tradelit Api Key")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_tradelit_token" value="{{setting_item('sms_tradelit_token',config('sms.tradelit.token')) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">{{__("From")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_tradelit_api_from" value="{{setting_item('sms_tradelit_api_from',config('sms.tradelit.from'))}}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row " data-condition="sms_driver:is(whatsapp)">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__('Config WhatsApp Driver')}}</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(whatsapp)">
                        <div class="form-group">
                            <label class="">{{__("WhatsApp Api Key")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_whatsapp_token" value="{{setting_item('sms_whatsapp_token',config('sms.whatsapp.token')) }}">
                            </div>
                        </div>
