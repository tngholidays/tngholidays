                                    ...
                                    @if($service = $row->service)
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/invoice_preview/'.$row->id)}}">{{__('Invoice Preview')}}</a>
                                                @if($booking->object_model == "event")
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/ticket_preview/'.$row->id)}}">{{__('Ticket Preview')}}</a>
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/mail_ticket/'.$row->id)}}">{{__('Ticket Mail Preview')}}</a>
                                                @endif

                                            @if($booking->object_model == "tour")
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/manage_itinerary/'.$row->id)}}">{{__('Manage Itinerary')}}</a>
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/manage_voucher/'.$row->id)}}">{{__('Manage Vouchers')}}</a>
                                            @endif
                                                <a class="dropdown-item" href="{{url('admin/module/report/booking/documents/'.$row->id)}}">{{__('Documents')}}</a>
                                            </div>
                                        </div>
        ...
        $(document).on('click', '#set_paid_btn', function (e) {
            ...
            $.ajax({
                ...
                data:{
                    ...
                    hotel_name: $('#modal-paid-'+id+' #set_hotel_name').val(),
                    ticket_conf_no: $('#modal-paid-'+id+' #set_ticket_conf_no').val(),
                },
                dataType:'json',
                type:'post',
