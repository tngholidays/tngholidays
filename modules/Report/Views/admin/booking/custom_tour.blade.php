                                        ...
                                        <div class="terms-scrollable">
                                            @foreach($attribute->terms as $term)
                                                <label class="term-item">
                                                    <input @if(!empty($selected_terms) and in_array($term->id, $selected_terms)) checked @endif price="{{$term->price}}"  transfer="{{$term->transfer_price}}" type="checkbox" name="terms[]" class="SightSeeing" value="{{$term->id}}">
