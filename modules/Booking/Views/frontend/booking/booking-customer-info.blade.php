        ...
        <div class="review-section">
            <div class="info-form">
                <ul>
                    ...
                    <li class="info-notes">
                        <div class="label">{{__('GSTN')}}</div>
                        <div class="val">{{$booking->gstn}}</div>
                    </li><li class="info-notes">
                        <div class="label">{{__('GSTN Holder Name')}}</div>
                        <div class="val">{{$booking->gst_holder_name}}</div>
                    </li>
                </ul>
            </div>
        </div>
