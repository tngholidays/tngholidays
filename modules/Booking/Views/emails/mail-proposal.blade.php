        ...
        <div class="b-email-wrap">
            <div class="" style="">
                <div class="b-container">
                    <div class="b-header">
                        <h1 class="site-title">{{$tour->title}}</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="b-container">
                <div class="b-panel">
                    <p>Please Find Out Booking Proposal:</p>

                    <div class="b-panel-title">Booking Proposal</div>
                    <div class="b-table-wrap">
                        <table class="b-table" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="val">{{ date('d M, Y', strtotime($row->start_date))}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
