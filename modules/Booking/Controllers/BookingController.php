...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function doCheckout(Request $request)
    {
        ...
        $booking->hotel_name = $request->input('hotel_name');
...
//        event(new VendorLogPayment($booking));
    ...
    public function setPaidAmount(Request $request){
        ...
        if (!empty($request->input('hotel_name'))) {
            $booking->hotel_name = $request->input('hotel_name');
        }
        
        if (!empty($request->input('ticket_conf_no'))) {
            if (!empty($booking->getMeta('ticket_conf_no'))) {
                $booking->updateMeta('ticket_conf_no', $request->input('ticket_conf_no'));
            }else{
                $booking->addMeta('ticket_conf_no', $request->input('ticket_conf_no'));
            }
        }
