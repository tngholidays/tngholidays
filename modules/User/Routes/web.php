...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::group(['prefix'=>'/booking'],function(){
        ...
        Route::get('{code}/itinerary','BookingController@bookingItinerary')->name('user.booking.itinerary');
        Route::get('{code}/voucher','BookingController@bookingVoucher')->name('user.booking.voucher');
        Route::get('{code}/document','BookingController@bookingDocument')->name('user.booking.document');
        Route::get('{code}/add-guest-details','BookingController@addGuestDetails')->name('user.booking.addGuestDetails');
        Route::post('storeGuestDetails/{id}','BookingController@storeGuestDetails')->name('user.booking.storeGuestDetails');
        Route::get('{code}/ticket','BookingController@ticket')->name('user.booking.ticket');
        Route::get('{code}/ticket-download','BookingController@ticketDownload')->name('user.booking.ticketDownload');
    });
