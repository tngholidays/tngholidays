...
<!--                                     <tr>
                ...
                <tr>
                    <td style="text-align: left; border: 1px solid #f1f1f1; background: #aedad5; font-size: 19px; padding: 8px 10px;"><img src="location-icon.png" style="width: 22px; float: left; margin: -4px 7px 0px 0px;" /><strong>Dubai </strong></td>
                ...
                <tr>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b> Thu, Oct 21, Day 1</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="home-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;">Check in to Excelsior Hotel Downtown (Formally known as Holiday Inn Downtown) - MMT Special, 4 Star</td>
                </tr>
                <tr>
                    <td rowspan="3" scope="rowgroup" style="text-align: left; vertical-align: top; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b>Fri, Oct 22, Day</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="food-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="book-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" scope="row" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Dubai Half Day Morning City Tour on shared transfer ( Except Friday )</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="book-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" scope="row" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Burj Khalifa At the Top 124th Floor Non-Prime Time Entry Ticket</td>
                </tr>
                <tr>
                    <td rowspan="2" scope="rowgroup" style="text-align: left; vertical-align: top; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b>Sat, Oct 23, Day 3</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="food-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="book-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" scope="row" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Desert Safari by 4X4 Vehicle with BBQ Dinner on Shared Transfer (3 Star Category)</td>
                </tr>
                <tr>
                    <td rowspan="2" scope="rowgroup" style="text-align: left; vertical-align: top; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b>Sun, Oct 24, Day 4</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="food-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="book-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" scope="row" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Return Private Transfer from Hotel to Dhow Cruise Creek</td>
                </tr>
                <tr>
                    <td scope="rowgroup" style="text-align: left; vertical-align: top; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b>Mon, Oct 25, Day 5</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="food-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
                    <td rowspan="2" scope="rowgroup" style="text-align: left; vertical-align: top; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; background: #f8f8f8; width: 144px;"><b>Tue, Oct 26, Day 6</b></td>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="food-icon.png" style="width: 22px;" /></td>
                    <td colspan="3" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #f1f1f1; font-size: 14px; padding: 5px 8px; border-left: 0px;"></td>
                    <td style="text-align: left; border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; width: 30px; border-right: 0px;"><img src="home-icon.png" style="width: 22px;" /></td>
                    <td colspan="4" scope="row" style="border: 1px solid #f1f1f1; font-size: 14px; padding: 8px 10px; border-left: 0px;">Breakfast at Hotel in Dubai</td>
                </tr>
                <tr>
