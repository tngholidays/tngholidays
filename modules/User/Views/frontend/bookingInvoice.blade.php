...
@section('head')
    ...
    <div id="invoice-print-zone">
        ...
        <div class="customer-info">
            ...
            <span>Name : {{$booking->first_name.' '.$booking->last_name}}</span><br>
            <span>Company Name : <b>{{$booking->gst_holder_name}}</b></span><br>
            <span>GSTN No :<b>{{$booking->gstn}}</b></span><br>
            <span>Address : </b>{{$booking->address}}</span><br>
            ...
            <span>Phone No. : {{$booking->phone}}</span><br>
