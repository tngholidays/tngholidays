...
@endif
<a href="https://api.whatsapp.com/send?phone=+917737887402&text=Hi" class="whatsappWidget " target="_blank">
...
<script src="{{ asset('js/widget.js?_ver='.config('app.version')) }}"></script>
    <script>
$(function() {
