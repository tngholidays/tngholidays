...
$menus = [
    ...
    'lead'=>[
        ...
        'children' => [
            ...
            'leadinteractions '=>[
                'url'        => 'admin/module/Lead/lead-interactions',
                'title'      => __('Lead Interactions')
            ],
            'leadcalllogs '=>[
                'url'        => 'admin/module/Lead/lead-call-logs',
                'title'      => __('Lead Call Logs')
            ],
        ],
        'permission' => 0,
    ],
    ...
    'forex'=>[
        ...
        'children' => [
            'forexmaster '=>[
                'url'        => 'admin/module/forex',
                'title'      => __('Forex Master')
            ],
            'forexorder '=>[
                'url'        => 'admin/module/forex/forex-order',
                'title'      => __('Forex Order')
            ]
        ],
        'permission' => 0,
    ],
