...
Route::group(['prefix'=>'ticket'],function (){
    ...
    Route::get('{event_id}/index','TicketController@index')->name('event.admin.ticket.index');
    Route::get('{event_id}/create','TicketController@create')->name('event.admin.ticket.create');
    Route::get('{event_id}/edit/{id}','TicketController@edit')->name('event.admin.ticket.edit');
    Route::post('{event_id}/store/{id}','TicketController@store')->name('event.admin.ticket.store');


    Route::post('/bulkEdit','TicketController@bulkEdit')->name('event.admin.ticket.bulkEdit');
