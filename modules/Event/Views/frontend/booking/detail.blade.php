                    ...
                    <?php 
                     ...
                     ?>
                        <li>
                            ...
                            <div class="val"> <strong>{{ $timeslot['time'] ?? null }}</strong> </div>
                        </li>
                        <li>
                            <div class="label">Adult * {{$type['adult_ticket']}}</div>
                            <div class="val">
                                {{format_money($type['adult_price'] * (int)$type['adult_ticket'])}}
                            </div>
                        </li>
                        <li>
                            <div class="label">Child * {{$type['child_ticket']}}</div>
                            <div class="val">
                                {{format_money($type['child_price'] * (int)$type['child_ticket'])}}
                            </div>
                        </li>
                    @endforeach
                @endif
