                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{route('event.admin.edit',['id'=>$row->id])}}">{{__("Edit Event")}}</a>
                                                <a class="dropdown-item" href="{{route('event.admin.ticket.index',['event_id'=>$row->id])}}">{{__("Manage Tickets")}}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
