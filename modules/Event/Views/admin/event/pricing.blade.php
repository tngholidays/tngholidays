                        ...
                        <div class="item" data-number="{{$key}}">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label>
                                        <input type="checkbox" min="0" name="extra_price[{{$key}}][per_ticket]" value="on" @if($extra_price['per_ticket'] ?? '') checked @endif >
                                        {{__("Price Per Ticket")}}
                                    </label>
                                </div>
                                <div class="col-md-1">
                ...
                <div class="item" data-number="__number__">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <label>
                                <input type="checkbox" min="0" __name__="extra_price[__number__][per_ticket]" value="on">
                                {{__("Price Per Ticket")}}
                            </label>
                        </div>
                        <div class="col-md-1">
